...
const WarpText = ({
  ...
  useEffect(() => {
    ...
    let pageReduceMotion = window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? false;
    let rasterVersion = 0;
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uMotion: { value: pageReduceMotion ? 0 : 1 }
      }
    });
    ...
    const onReducedMotion = event => {
      pageReduceMotion = event.matches;
      program.uniforms.uMotion.value = pageReduceMotion ? 0 : 1;
      renderOnce();
    };
    ...
    const loop = now => {
      ...
      program.uniforms.uPointerActive.value = pageReduceMotion ? pointer.active * 0.35 : pointer.active;
      program.uniforms.uTime.value = pageReduceMotion ? 0 : elapsed;
